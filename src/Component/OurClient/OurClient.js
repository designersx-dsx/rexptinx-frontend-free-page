...
const OurClient = () => {
    ...
    const testimonials = [
        {
            text: `“RBefore Rexpt, we were losing emergency calls after hours—and that's where the high-value jobs are. Now, Rexpt’s 24/7 AI captures every single lead, qualifies the emergency level, and texts the details straight to the on-call tech. We’ve seen a 30% jump in high-value night and weekend jobs.”`,
            author: "Mark Johnson",
        },
        {
